...
const { loginUser, registerUser, getUsers, getDeletedUsers, getChangedUsers, deleteUser, changeUserPassword, lookupByCode, setPassword } = require('../controllers/authController');
