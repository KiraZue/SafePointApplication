      ...
      <div className="mb-8 max-w-2xl mx-auto flex flex-col gap-4 relative">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-red-600 text-white px-5 py-3 rounded-full text-xs font-black uppercase tracking-widest shadow-md hover:brightness-110 active:scale-95 transition-all"
