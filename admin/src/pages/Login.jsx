      ...
      <div className="w-[520px] p-8 bg-white rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="submit"
              className="flex-1 px-6 py-3 rounded-2xl bg-[#2f4863] text-white font-extrabold cursor-pointer hover:bg-red-600 transition-colors"
            >
              LOGIN
            </button>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm font-bold text-gray-500">
            ...
            <button
              ...
              className="text-[#2f4863] hover:text-red-600 underline transition-colors"
            >
              Register here
            </button>
          </p>
