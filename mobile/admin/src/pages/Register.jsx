        ...
        >
            <div className="w-[520px] p-8 bg-white rounded-2xl shadow-lg">
                ...
                {step === 'code' && (
                    <form onSubmit={handleLookup}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full px-6 py-3 rounded-2xl bg-[#2f4863] text-white font-extrabold cursor-pointer hover:bg-lime-500 hover:text-black transition-colors disabled:opacity-50"
                        >
                    ...
                    <div className="animate-in fade-in transition-all duration-300">
                        ...
                        <div className="flex gap-3">
                            <button
                                ...
                                className="flex-1 px-6 py-3 rounded-2xl bg-[#2f4863] text-white font-extrabold hover:bg-lime-500 hover:text-black transition-colors"
                            >
                                THIS IS ME
                            </button>
                            <button
                ...
                <div className="mt-8 text-center border-t border-gray-50 pt-4">
                    <button
                        onClick={() => navigate('/')}
                        className="text-[10px] font-black text-[#2f4863] uppercase tracking-widest hover:text-lime-500 transition-colors"
                    >
                        Back to Login
                    </button>
                </div>
